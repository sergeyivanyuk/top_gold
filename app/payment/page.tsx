				...
				<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-xs">
					...
					>
						...
						>
							...
							<p>6. Призы отправляются только для компьютерной версии игры!
							PS4, ХВОХ, Blitz имеют другие игровые магазины и не имеют обратной совместимости!</p>
							<p>7. TOPGOLD.STORE не связан с Lesta, Lesta Group и Wargaming!</p>
						</div>
						<button
